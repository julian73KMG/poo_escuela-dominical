...
public class Nino extends Persona {
    public Grupo grupo;
    public ArrayList<Tematica> temasVistos;
    public HashMap<String, String> acudientes;
    ...
    public Nino(String nombre, String genero, int año, int mes, int dia, String contacto, String acudiente) {
